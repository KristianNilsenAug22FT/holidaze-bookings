...
import AvailabilityCalendar from './AvailabilityCalendar'; // Import the calendar component
...
function BookingForm({ venueId, onBookingSuccess }) {
    ...
    const handleBooking = async (e) => {
        ...
        setMessage('');
        if (guests > maxGuests) {
            setMessage(`The maximum number of guests for this venue is ${maxGuests}.`);
            return;
        }
        try {
            ...
            if (response.ok) {
                ...
                onBookingSuccess();  // Callback to refresh available dates or any other actions
            } else {

...
import AvailabilityCalendar from "../components/widget/AvailabilityCalendar";
...
function Profile() {
              ...
              <li key={booking.id} className="booking-item">
                ...
                {editingBooking && editingBooking.id === booking.id && (
                  <div className="edit-booking-form">
                    ...
                    />
                    {guestWarning && (
                      <div className="alert alert-warning">{guestWarning}</div>
                    )}
                    <button
  ...
  if (!isLoggedIn) {
    return <div className="alert alert-danger mt-3">User is not logged in</div>;
  }
